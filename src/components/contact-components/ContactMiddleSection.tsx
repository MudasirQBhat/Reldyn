  ...
  return (
    <>
      <div className="bg-primary-background" data-aos="fade-right">
        <div className="grid grid-cols-8 lg:grid-cols-12 w-full  px-6 lg:px-20 py-20 pb-80">
          ...
          <div className=" w-full  col-span-8 lg:col-span-4">
            <div className="w-full relative">
              <img
                ...
                className="lg:rounded-tr-3xl w-full"
              />
            ...
            <div className="w-full relative">
              <img
                ...
                alt="Malaysia Contact Image"
                className="rounded-b-3xl lg:rounded-br-3xl lg:rounded-bl-none w-full"
              />
              <h1 className=" font-roboto text-primary-color font-font-700 text-1xl lg:text-2xl absolute top-20 left-4 lg:top-36 lg:left-12">
                India
              </h1>
