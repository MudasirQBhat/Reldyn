  ...
  return (
    <>
      <div className="bg-primary-background" data-aos="fade-right">
        <div className="w-[90%] mx-auto flex flex-col md:flex-row md:gap-72">
          <div className="pt-16 space-y-8">
            <div className="space-y-4">
              ...
              <p className=" font-roboto font-font-700 text-secondary-color text-sm md:text-xl w-1/2">
            ...
            <div className="space-y-4 md:space-y-6">
              <div>
                ...
                <p className="font-roboto font-font-700 text-color-black text-1xl md:text-2xl">
                  info@reldyn.com
                </p>
              </div>
              <div className="">
          ...
          <div data-aos="fade-right">
            <img
              src={contactImage}
              alt="Reldyn Image"
              className="w-full md:w-4/5 mt-12 object-cover"
            />
          </div>
        </div>
      </div>
